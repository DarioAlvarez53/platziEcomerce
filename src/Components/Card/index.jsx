    ...
    return (
        <div className="bg-white cursor-pointer w-56 h-60 rounded-lg shadow-lg">
            <figure className="relative mb-2 w-full h-4/5">
                ...
                <img src="https://images.pexels.com/photos/1649771/pexels-photo-1649771.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Headphones" className="w-full h-full object-cover rounded-t-lg" />
